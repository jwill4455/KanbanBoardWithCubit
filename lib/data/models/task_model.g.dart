...
TaskModel _taskModelDeserialize(
  ...
  final object = TaskModel(
    ...
    id: id,
    startedAt: reader.readDateTimeOrNull(offsets[3]),
    status: _TaskModelstatusValueEnumMap[reader.readByteOrNull(offsets[4])] ??
        TaskStatus.toDo,
    title: reader.readString(offsets[5]),
    totalTime: reader.readLongOrNull(offsets[6]),
  );
  return object;
}
...
extension TaskModelQueryFilter
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterFilterCondition> totalTimeIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterFilterCondition> totalTimeEqualTo(
      int? value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'totalTime',
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterFilterCondition> totalTimeLessThan(
    int? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterFilterCondition> totalTimeBetween(
    int? lower,
    int? upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension TaskModelQuerySortBy on QueryBuilder<TaskModel, TaskModel, QSortBy> {
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterSortBy> sortByTotalTime() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'totalTime', Sort.asc);
    });
  }

  QueryBuilder<TaskModel, TaskModel, QAfterSortBy> sortByTotalTimeDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension TaskModelQuerySortThenBy
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterSortBy> thenByTotalTime() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'totalTime', Sort.asc);
    });
  }

  QueryBuilder<TaskModel, TaskModel, QAfterSortBy> thenByTotalTimeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'totalTime', Sort.desc);
    });
  }
...
extension TaskModelQueryWhereDistinct
  ...
  QueryBuilder<TaskModel, TaskModel, QDistinct> distinctByTotalTime() {
    return QueryBuilder.apply(this, (query) {
...
extension TaskModelQueryProperty
  ...
  QueryBuilder<TaskModel, int?, QQueryOperations> totalTimeProperty() {
    return QueryBuilder.apply(this, (query) {
